...
<%
    ...
    //List<SiteMVCTelerik.Models.ModuloBasico.VOs.Municipio> lista = new List<SiteMVCTelerik.Models.ModuloBasico.VOs.Municipio>();

    //lista.Add(new SiteMVCTelerik.Models.ModuloBasico.VOs.Municipio
    //{
    //    nome = "Selecione...",
    //    uf = "0"
    //});
