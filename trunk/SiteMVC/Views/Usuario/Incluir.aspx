    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.area_id) %>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.escolaridade_id) %>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.estadoscivistipo_id) %>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.orgaosexpedidoresnome_id) %>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.uf_resid) %>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.usuariotipo_id) %>
