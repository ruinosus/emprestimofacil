...
<asp:Content ID="Content2" ContentPlaceHolderID="Principal" runat="server">
    ...
    <fieldset>
        ...
        <div class="display-field"><%: Model.escolaridade_id %></div>
        
        <div class="display-label">estadoscivistipo_id</div>
        <div class="display-field"><%: Model.estadoscivistipo_id %></div>
        ...
        <div class="display-field"><%: Model.orgaosexpedidoresnome_id %></div>
