...
<%if (SiteMVC.Models.ModuloBasico.VOs.ClasseAuxiliar.AreaSelecionada != null)
                      {
                       %>
                    Area Selecionada - <b><%:SiteMVC.Models.ModuloBasico.VOs.ClasseAuxiliar.AreaSelecionada.descricao %></b><br />
                    ...
                    <%}
                      ...
                      %>
                      Data Selecionada - <b><%:SiteMVC.Models.ModuloBasico.VOs.ClasseAuxiliar.DataSelecionada.ToString("dd/MM/yyyy")%></b><br />
                      <%} %>
<%
    }
    else {
